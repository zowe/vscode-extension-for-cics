...
export function getFilterAllProgramsCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllPrograms", async (node) => {
...
export function getFilterAllTasksCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllTasks", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
...
export function getFilterAllLibrariesCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllLibraries", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
...
export function getFilterAllTCPIPServicesCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllTCPIPServices", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
...
export function getFilterAllURIMapsCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllURIMaps", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
...
export function getFilterAllPipelinesCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllPipelines", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
...
export function getFilterAllWebServicesCommand(tree: CICSTree, treeview: TreeView<any>) {
  return commands.registerCommand("cics-extension-for-zowe.filterAllWebServices", async (node) => {
    const selection = treeview.selection;
    let chosenNode;
    if (node) {
      chosenNode = node;
